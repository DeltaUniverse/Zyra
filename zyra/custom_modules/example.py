...
class CallbackHandler(module.Module):
    ...
    async def show_menu(self, ctx: listener.Context) -> None:
        """Show main menu with callback buttons."""
        keyboard = [
            [
    ...
    async def show_counter(self, ctx: listener.Context) -> None:
        """Show counter with interactive buttons."""
    ...
    async def handle_callback(self, ctx: listener.Context) -> None:
        ...
        # Let the dedicated back handler process this.
    ...
    async def _handle_info(self, query) -> None:
    ...
    async def _handle_random(self, query) -> None:
        ...
        # Back and generate again buttons
        keyboard = [
    ...
    async def _handle_time(self, query) -> None:
        """Handle time callback."""
    ...
    async def _handle_refresh(self, query) -> None:
        """Handle refresh callback (regenerate menu)."""
        keyboard = [
            [
                InlineKeyboardButton("📊 Status", callback_data="status"),
                InlineKeyboardButton("ℹ️ Info", callback_data="info"),
    ...
    async def _handle_close(self, query) -> None:
        """Handle close callback."""
        await query.message.delete()

    async def _handle_counter(self, query, data: str) -> None:
    ...
    async def _handle_back_to_menu(self, query) -> None:
    ...
    async def handle_back_callback(self, ctx: listener.Context) -> None:
        """Handle back to menu callback specifically."""
        query = ctx.update.callback_query
